...
public class ContentRepository_VoiceSoundClipPageTest extends BaseClass {
	...
	public ContentRepository_VoiceSoundClipPageTest() {
	...
	public Object[][] getexceldata() throws Exception {
		 ...
		 "./TestData/Data.xlsx");
		 String sheetName =  prop.getProperty("ContentRepository_Voice");
		 
		
		  int row = reader.getrowCount("ContentRepository_Voice");
		  
		  int column = reader.getColumnCount("ContentRepository_Voice");
		  ...
		  data[i][j] = reader.getData("ContentRepository_Voice", i + 1, j); } } return data; }
...
public void voiceContent(String voiceClipName, String voiceDescriotion, String voiceType, String soundPath,String approveType, String ApproveContent, String ActionDescripton, String Action) throws InterruptedException   {
	ContentRepositoryVoiceSoundClipPage.gotoVoice();
	ContentRepositoryVoiceSoundClipPage.CreateVoiceTemplate(voiceClipName, voiceDescriotion, voiceType, soundPath);
